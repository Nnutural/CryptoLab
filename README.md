...
当前 35 页 PDF 报告材料已整理到 `docs/report/` 和 `docs/report_assets/`。其中 [FINAL_REPORT.md](./docs/report/FINAL_REPORT.md) 是主稿，[STATS.md](./docs/report_assets/STATS.md) 汇总源码、端点、测试、Docker 和截图统计；Fig.1-Fig.6 均有 PNG/SVG 与数据 CSV，`FIGURE_QA.md` 记录质量检查结果。
...
> 说明：`FIGURE_INDEX.md` 明确这些 Fig.1-Fig.6 是实验数据图，不包含架构图。系统架构图在本 README 使用 Mermaid 表达，报告主稿也在第 2 章给出分层架构图。
